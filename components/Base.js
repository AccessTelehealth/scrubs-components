...
const Base = (props: PropsType): React.Element<*> => {
  const {
    ...
    fontSizeInherit, sans, fontFamilyInherit, textDecorationNone, bold, regular,
    italic, uppercase, spaced, leftAlign, centerAlign, rightAlign, justify,
    antialiased, truncate, underline,
