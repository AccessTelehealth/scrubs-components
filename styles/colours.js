...
export default ({
  ...
  return classNames({
    ...
    [styles.textGreyBlue]: textColour === 'greyBlue',
    ...
    [styles.fillGreyBlue]: fillColour === 'greyBlue',
    ...
    [styles.bgGreyBlue]: backgroundColour === 'greyBlue',
    ...
    [styles.borderGreyBlue]: borderColour === 'greyBlue',
